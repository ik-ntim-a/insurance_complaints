...
INSERT INTO insurance_complaints.dbo.complaint_resolution_table(
...
SELECT TOP 100
*
FROM complaint_resolution_table;
...
ALTER TABLE insurance_complaints.dbo.complaint_resolution_table
ADD CONSTRAINT FK_distinct_complaint_2
